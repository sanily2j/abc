<div class="outgoingCertificateCombos form">
	...
	<div class="h2bg"><span class="h2-left"></span>
 	...
 	<h2><?php ___('admin copy outgoing certificate combo'); ?></h2>
	    </span>
	<span class="h2-right"></span></div>
 	
 	<?php
	echo $this->element('toolbar/toolbar', array('plugin' => 'alaxos', 'list' => true, 'back_to_view_id' => $outgoingCertificateCombo['OutgoingCertificateCombo']['id']));
	?>
