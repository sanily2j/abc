...
{
	$(".inputDate").bind("blur", function(e){
			format_date(this);
		});

	$(".inputFloat").bind("keyup", function(e){
			format_number(this, true);
		});
	
	$(".inputInteger").bind("keyup", function(e){
	 ...
	 */
	$("tr.searchHeader input").each(function(){
	...
	$("tr.searchHeader select").each(function(){
		$(this).keypress(function(e){
			if(e.keyCode == 13)
			{
				search();
	...
	*/
	$("table.administration > tbody > tr").each(function(i){
	
		if($("a.to_detail", this).length > 0)
		{
			$(this).bind("dblclick", function(){
		
//				window.location = $("a.to_detail", this).attr("href");
                                $("a.to_detail", this).click();
				
			});	
		}
		else if($("#detail", this).length > 0)
		{
			/*
...
//				window.location = $("#detail", this).attr("href");
				$("#detail", this).click();
	...
	*/
	$('#chooseActionForm').submit(function() {
