...
class AlaxosHtmlHelper extends HtmlHelper
{
	...
	/**
	 * Easy method to return an i18n value of 'Active' or 'Inactive', depending of the given value.
	 *
	 * @param mixed $value
	 */
	function get_active_inactive($value = null)
	{
	    switch($value)
	    {
	        case '1':
	        ...
	        case 'yes':
	        case true:
	            return __d('alaxos', 'Active', true);
	            break;
	        default:
	            return __d('alaxos', 'Inactive', true);
	            break;
	    }
	}
