 ...
 */
	function _check() {
		$_this =& Validation::getInstance();
                // if field is type file and has not empty validation
                if ($_this->regex == '/[^\s]+/m' && is_array($_this->check) && !empty($_this->check['name'])) {
                    $_this->error[] = false;
			return true;
                } else if ($_this->regex == '/[^\s]+/m' && is_array($_this->check) && empty($_this->check['name'])) {
                    $_this->error[] = true;
                    return false;
                }
                // normal validation
